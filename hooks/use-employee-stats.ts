...
import { buildStatsFromRows, type EmployeeStats, type RawRow } from "@/lib/data/employee-stats"
...
export function useEmployeeStats() {
  ...
  useEffect(() => {
    let cancelled = false
    const tableName = process.env.NEXT_PUBLIC_SUPABASE_EMPLOYEE_TABLE || "employees"
