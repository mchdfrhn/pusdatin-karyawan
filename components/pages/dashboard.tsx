...
export function EmployeeDashboard({ stats }: EmployeeDashboardProps) {
  ...
  const ratioText = femaleEmployees
    ? `${(maleEmployees / femaleEmployees).toFixed(2)} : 1`
    : "-";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 print:grid-cols-3">
        {employeeCategories.map((category) => {
          ...
          const percentText = totalEmployees
            ? ((value / totalEmployees) * 100).toFixed(1)
            : "0.0";
          return (
            <div
              key={category.label}
              className={`group relative overflow-hidden rounded-xl bg-gradient-to-br ${category.color} p-6 text-white shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 print-break-inside-avoid`}
            >
              <div className="absolute right-0 top-0 opacity-10 text-6xl">
                {category.icon}
              </div>
      ...
      {/* Gender Statistics */}
      <div className="grid gap-6 md:grid-cols-2 print:block print:gap-4">
        <Card className="border border-slate-200 shadow-sm print-break-inside-avoid print:mb-4">
              ...
              <div className="rounded-lg bg-blue-50 p-4">
                ...
                <div className="mt-2 h-2 overflow-hidden rounded-full bg-slate-200">
                  <div
                    ...
                    style={{
                      width: `${totalEmployees ? (maleEmployees / totalEmployees) * 100 : 0}%`,
                    }}
                  />
                </div>
              ...
              <div className="rounded-lg bg-pink-50 p-4">
                ...
                <div className="mt-2 h-2 overflow-hidden rounded-full bg-slate-200">
                  <div
                    ...
                    style={{
                      width: `${totalEmployees ? (femaleEmployees / totalEmployees) * 100 : 0}%`,
                    }}
                  />
                </div>
                <p className="mt-1 text-xs text-slate-600">
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4 rounded-lg bg-gradient-to-r from-indigo-50 to-indigo-100 p-4">
                ...
                <ul className="mt-3 space-y-1 text-xs text-indigo-800">
                  ...
                  <li>
                    • <strong>PPPK</strong>: Pegawai Pemerintah dengan
                    Perjanjian Kerja
                  </li>
                  <li>
                    • <strong>PPnPN</strong>: Pegawai tidak Tetap Pemerintah Non
                    PNS
                  </li>
                  <li>
